...
const { FiLock, FiCheckCircle } = FiIcons;
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg border border-gray-200 w-full max-w-md p-8 text-center"
        >
          <SafeIcon icon={FiCheckCircle} className="text-green-500 text-5xl mx-auto mb-4" />
